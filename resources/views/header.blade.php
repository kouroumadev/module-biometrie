<div class="header w-100">
    ...
    <div class="contact" style="">
        ...
        <div class="dashboard-setting user-notification" style="padding-top: 10px ">
            <div class="dropdown" style="font-size: 12px; font-family:Poppins, sans-serif">
                ...
                <span style="margin-left: 45px;"> Appelez-nous</span>
            </div>
        </div>
        <div class="dashboard-setting user-notification" style="padding-top: 10px ">
            <div class="dropdown" style="font-size: 12px; font-family:Poppins, sans-serif">
                ...
                <span style="margin-left: 45px;"> Contactez-nous</span><br>
            </div>
        </div>
    ...
    <div class="header-right">
        <div class="user-notification" style="position: relative; top: -70px; right: -70px;">
            <div class="dropdown">
